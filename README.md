...
> **Status: 0.3.9 released.** Sixteen engines, a `twinscope` command line, projects,
> saved comparisons, shareable reports and an opt-in update check. 0.3.9 is a fix
> release over 0.3.8, whose macOS and Linux arm64 builds compare real PDFs as
> binaries — take 0.3.9 if you compare PDFs. The macOS builds are **unsigned** — macOS will refuse to open
